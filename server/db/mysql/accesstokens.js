...
var query = {};
query.find = 'select token, clientId, userId, expirationDate from accessTokens where token = ?;';
query.save = 'insert into accessTokens(token, clientId, userId, expirationDate) values (?,?,?,?);';
query.delete = 'delete from accessTokens where token = ?;';
query.deleteByClientIdExceptNewToken = 'delete from accessTokens where clientId = ? and token <> ?;';
query.deleteByClientId = 'delete from accessTokens where clientId = ?;';
